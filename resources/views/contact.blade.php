            ...
            <div class="row px-xl-5">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            <div class="control-group">
                                <input type="text" class="form-control" id="name" placeholder="Nama"
                                    required="required" data-validation-required-message="Mohon Ketikan Nama Anda" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="email" class="form-control" id="email" placeholder="Email"
                                    required="required" data-validation-required-message="Mohon Email Anda" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control" id="subject" placeholder="Subjek"
                                    required="required" data-validation-required-message="Mohon Masukkan Subjek" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                ...
                <div class="col-lg-5 mb-5">
                    <div class="d-flex flex-column mb-3">
                        ...
                        <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>haikyuumargonda@exsamp.com</p>
                        <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>083892003762</p>
                    </div>
                    <div class="d-flex flex-column">
                        <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                        <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Kelapa Gading, Jakarta
                            Utara</p>
                        <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>haikyuukelapagading@exsamp.com
                        </p>
                        <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>087123784690</p>
                    </div>
                </div>
            </div>
        </div>
